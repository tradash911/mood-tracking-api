...
const createSendToken = (user, statusCode, res) => {
  ...
  /*  const cookieOptions = {
    ...
    httpOnly: true,
    sameSite: "None", // ha külön domain, külön port miatt is!
    secure: true, // production alatt kötelező sameSite: "None" mellé
  };
 */
  ...
  const cookieOptions = {
    ...
    secure: false, // csak prodban true
    path: "/", // mindenhova érvényes
  };
